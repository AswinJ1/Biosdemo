  ...
  return (
    <section className="bg-white text-black dark:bg-black dark:text-white py-16 px-4 sm:px-8 md:px-12 lg:px-24">
      <div className="max-w-5xl mx-auto text-center mb-16">
        <h2 className="text-3xl sm:text-4xl font-bold text-black dark:text-white mb-8 font-roboto">Organized CTF Events</h2>
        <p className="text-gray-700 dark:text-gray-300 text-sm sm:text-base max-w-2xl mx-auto font-roboto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 px-4 sm:px-8">
          {events.map((event, index) => (
            ...
            >
              <h3 className="text-indigo-500 uppercase text-sm sm:text-base font-roboto">{event.name}</h3>
              <p className="text-gray-500 text-center text-sm sm:text-base font-roboto">{event.description}</p>
            </div>
          ))}
        </div>
      </div>
